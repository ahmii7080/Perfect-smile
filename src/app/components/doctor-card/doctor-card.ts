...
@Component({
  ...
  template: `
    <article class="doc-card lift">
      <div
        class="doc-card__head"
        [style.background]="'linear-gradient(135deg,' + doctor.color + ', #0C4A6E)'"
      >
        <div
      ...
      <div class="doc-card__body">
        ...
        <div class="doc-card__social">
          <a
            href="https://www.facebook.com/share/1E8Z7uagMK/"
            aria-label="Facebook"
            target="_blank"
            rel="noopener"
          ...
          ></a>
          <a
            href="https://www.instagram.com/perfect_smile_dental_.clinic?igsh=b2swaXZyemdveGRr"
            aria-label="Instagram"
            target="_blank"
            rel="noopener"
            ><i class="fa-brands fa-instagram"></i
          ></a>
          <a href="https://wa.me/923247734135" aria-label="WhatsApp" target="_blank" rel="noopener"
