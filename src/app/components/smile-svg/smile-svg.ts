            ...
            <g>
              ...
              @if (variant === 'after') {
                <ng-container>
                  ...
                  <text x="172" y="42" fill="#0EA5E9" font-size="14" font-family="sans-serif">
                    +
                  </text>
                </ng-container>
              }
